    ...
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader><DialogTitle>{editing ? 'Edit Donasi' : 'Tambah Donasi Baharu'}</DialogTitle><DialogDescription className="sr-only">Borang untuk menambah atau mengedit donasi</DialogDescription></DialogHeader>
